			...
			<div class="container">
				...
				<div class="col-lg-4">
					<div class="jumbotron" style="padding-top:20px;">
						<form action="joinAction.jsp" method="post"> <!-- 로그인 처리를 loginAction에서 처리해준다.  -->
							...
							<div class="form-group" style="text-align: center; ">
								...
								<div class="form-group">
									<input type="email" class="form-control" placeholder="이메일" name="userEmail" maxlength="30" required="required">
								</div>									
